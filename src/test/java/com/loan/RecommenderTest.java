...
public class RecommenderTest {
    ...
    private Lender[] len0 = {
            ...
            new Lender("l2", new BigDecimal("0.06"), 200),
            new Lender("l3", new BigDecimal("0.01"), 100),
            new Lender("l4", new BigDecimal("0.02"), 500),
    ...
    public void testGetAvailableLenders() {
        ...
        assertTrue(l0[2].getLender().equals("l5"));
        assertTrue(l0[3].getLender().equals("l2"));
        ...
        assertTrue(l1[2].getLender().equals("l5"));
        assertTrue(l1[3].getLender().equals("l2"));
